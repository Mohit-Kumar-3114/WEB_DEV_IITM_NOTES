...
const { placeOrderCOD, getUserOrders, allOrders, updateOrderStatus, placeOrderRazorpay, verifyRazorpay } = require("./controllers/orderController")
const app = express()
...
app.post("/api/v1/place-order-by-cod", authUser, placeOrderCOD)
app.post("/api/v1/get-user-orders", authUser, getUserOrders)
// app.post("/api/v1/place-order-by-razorpay", authUser, placeOrderRazorpay)
// app.post(".api/v1/verify-razorpay", authUser, verifyRazorpay)
app.post("/api/v1/all-orders", authAdmin, allOrders)
app.put("/api/v1/update-order-status", authAdmin, updateOrderStatus)
